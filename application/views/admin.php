                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li><button href="<?php echo base_url(); ?>index.php/c_rapat/add" class="btn btn-success btn-xs"><i class="fa fa-plus"></i> Tambah Rapat</button>
                    </ul>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                            ...
                            echo "<tr>
                                ...
                                for ($i = 0; $i < $count; $i++){
                                  ...
                                  <td>
                                    ...
                                    <a href="<?php echo base_url()?>uploads/rispat/<?php echo $data['id'][$i];?>.pdf"><img width="50px" src="<?php echo base_url()?>assets/img/pdf.png"></a>
                                    <a href="<?php echo base_url(); ?>index.php/c_rapat/upload_rispat/<?php echo $data['id'][$i];?>" class="btn btn-default btn-xs"><span class="glyphicon glyphicon-upload"></span>
                                  </td>
                                  <td>
                                    <?php echo $data['daftar_hadir'][$i]; ?>
                                    <a href="<?php echo base_url()?>uploads/daftar_hadir/<?php echo $data['id'][$i];?>.pdf"><img width="50px" src="<?php echo base_url()?>assets/img/pdf.png"></a>
                                    <a href="<?php echo base_url(); ?>index.php/c_rapat/upload_daftarhadir/<?php echo $data['id'][$i];?>" class="btn btn-default btn-xs"><span class="glyphicon glyphicon-upload"></span>
                                  </td>
                                  <td>
