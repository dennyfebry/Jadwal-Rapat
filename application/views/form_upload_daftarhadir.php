        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Tambah Rispat <!-- <small>Users</small> --></h2>
                  ...
                  <div class="x_content">
                    ...
                    <?php echo form_open_multipart('c_rapat/do_upload_daftarhadir');?>
                    <input type="hidden" class="form-control"  name="id" value="<?php echo $id;?>">
                      <div class="form-group">
                        <!-- <div class="box"> -->
                        <input type="file" name="daftar_hadir" id="files" class="inputfile" />
