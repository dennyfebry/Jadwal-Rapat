            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <?php echo $error;?>
                    <!-- <form role="form" action="<?php echo base_url(); ?>index.php/c_rapat/do_upload_rispat/<?php echo $obj->id;?>" method="POST"> -->
                    <?php echo form_open_multipart('c_rapat/do_upload_rispat/');?>
                    <input type="hidden" class="form-control"  name="id" value="<?php echo $id;?>">
                      <div class="form-group">
                        <!-- <div class="box"> -->
                        <input type="file" name="rispat" id="files" class="inputfile" />
